...
angular
    .module('app')
    .controller('AssignStagesController', AssignStagesController);

AssignStagesController.$inject = ['$location','ProjectService', 'EtapaService', 'MaterialService'];
function AssignStagesController($location, ProjectService, EtapaService, MaterialService) {
