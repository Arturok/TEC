...
Ventana = Tk()
Ventana.title("CONVERSIONES") #tittulo de ventana
...
def resultado ():
    ...
    try:        
        ...
        messagebox.showinfo(title="Resultado",message="Por favor ingrese un numero válido.")                                                          
...
def ventanaDP(): 
    ...
    imagenFondoDP = cargarImagen("FondoDP.png")
...
def cargarImagen(nombre):
    ...
    return imagen
#Cargando imagenes
imagenFondo = cargarImagen("Fondo3.png")
lblFondo = Label(Ventana, image=imagenFondo).place(x=0, y=0)
imagenL = cargarImagen("python.png")
...
imagenDescPant = cargarImagen("DescPant.png")
btnMusic = Button(Ventana, image=imagenDescPant,command=ventanaDP).place(x=710,y=100)
